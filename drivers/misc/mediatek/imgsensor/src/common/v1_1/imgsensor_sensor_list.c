...
{S5KGW1SP_SENSOR_ID, SENSOR_DRVNAME_S5KGW1SP_MIPI_RAW, S5KGW1SP_MIPI_RAW_SensorInit},
#endif
#if defined(S5KGW1SUNNY_MIPI_RAW)
{S5KGW1SUNNY_SENSOR_ID, SENSOR_DRVNAME_S5KGW1SUNNY_MIPI_RAW, S5KGW1SUNNY_MIPI_RAW_SensorInit},
#endif
#if defined(S5KGW1OFILM_MIPI_RAW)
{S5KGW1OFILM_SENSOR_ID, SENSOR_DRVNAME_S5KGW1OFILM_MIPI_RAW, S5KGW1OFILM_MIPI_RAW_SensorInit},
#endif
#if defined(S5K3T1SUNNY_MIPI_RAW)
{S5K3T1SUNNY_SENSOR_ID, SENSOR_DRVNAME_S5K3T1SUNNY_MIPI_RAW, S5K3T1SUNNY_MIPI_RAW_SensorInit},
#endif
#if defined(S5K3T1OFILM_MIPI_RAW)
{S5K3T1OFILM_SENSOR_ID, SENSOR_DRVNAME_S5K3T1OFILM_MIPI_RAW, S5K3T1OFILM_MIPI_RAW_SensorInit},
#endif
#if defined(S5K3T2_MIPI_RAW)
{S5K3T2_SENSOR_ID, SENSOR_DRVNAME_S5K3T2_MIPI_RAW, S5K3T2_MIPI_RAW_SensorInit},
#endif
#if defined(OV02A10AF_MIPI_RAW)
{OV02A10AF_SENSOR_ID, SENSOR_DRVNAME_OV02A10AF_MIPI_RAW, OV02A10AF_MIPI_RAW_SensorInit},
#endif
...
{GC2375ALPHA_SENSOR_ID, SENSOR_DRVNAME_GC2375ALPHA_MIPI_RAW, GC2375ALPHA_MIPI_RAW_SensorInit},
#endif
#if defined(OV02A10BETA_MIPI_RAW)
{OV02A10BETA_SENSOR_ID, SENSOR_DRVNAME_OV02A10BETA_MIPI_RAW, OV02A10BETA_MIPI_RAW_SensorInit},
#endif
#if defined(OV02A10ALPHA_MIPI_RAW)
{OV02A10ALPHA_SENSOR_ID, SENSOR_DRVNAME_OV02A10ALPHA_MIPI_RAW, OV02A10ALPHA_MIPI_RAW_SensorInit},
#endif
#if defined(OV8856SUNNY_MIPI_RAW)
{OV8856SUNNY_SENSOR_ID, SENSOR_DRVNAME_OV8856SUNNY_MIPI_RAW, OV8856SUNNY_MIPI_RAW_SensorInit},
#endif
#if defined(OV8856OFILM_MIPI_RAW)
{OV8856OFILM_SENSOR_ID, SENSOR_DRVNAME_OV8856OFILM_MIPI_RAW, OV8856OFILM_MIPI_RAW_SensorInit},
#endif
	/*IMX*/
